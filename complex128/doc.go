/*
Package itercomplex128 provides tools for creating iterators for the complex128 type.
...
For example, we can turn a slice into an iterator, with code like the following:
	...
	var slice []complex128 = []complex128 {
		1.0,
		1.0i,
		-1.0,
		-1.0i,
	...
	for iterator.Next() {
		...
		var datum complex128 // Could have also used: var datum interface{}
