/*
Package iterint64 provides tools for creating iterators for the int64 type.
...
For example, we can turn a slice into an iterator, with code like the following:
	...
	for iterator.Next() {
		...
		var datum int64 // Could have also used: var datum interface{}
