/*
Package itertime provides tools for creating iterators for the time.Time type.
...
For example, we can turn a slice into an iterator, with code like the following:
	...
	for iterator.Next() {
		...
		var datum time.Time // Could have also used: var datum interface{}
