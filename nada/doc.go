/*
Package iternada provides tools for creating iterators for the struct{} type.
...
For example, we can turn a slice into an iterator, with code like the following:
	...
	for iterator.Next() {
		...
		var datum struct{} // Could have also used: var datum interface{}
