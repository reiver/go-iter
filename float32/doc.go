/*
Package iterfloat32 provides tools for creating iterators for the float32 type.
...
For example, we can turn a slice into an iterator, with code like the following:
	...
	for iterator.Next() {
		...
		var datum float32 // Could have also used: var datum interface{}
