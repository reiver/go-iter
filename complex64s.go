...
func (receiver *Complex64s) Close() error {
	return nil
}
...
func (receiver *Complex64s) Decode(x interface{}) error {
	if nil == receiver {
...
func (receiver *Complex64s) Err() error {
	if nil == receiver {
		return errNilReceiver
	}
...
func (receiver *Complex64s) Next() bool {
	if nil == receiver {
		return false
	}
