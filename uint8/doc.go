/*
Package iteruint8 provides tools for creating iterators for the uint8 type.
...
For example, we can turn a slice into an iterator, with code like the following:
	...
	for iterator.Next() {
		...
		var datum uint8 // Could have also used: var datum interface{}
